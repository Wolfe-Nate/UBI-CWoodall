...
function German() {
    ...
    <a className='translate' href="/">Translate to English</a>
            ...
            <div className='about-us'>
                <div>
                    <img
                        src='https://grundeinkommens-de.s3.us-west-2.amazonaws.com/tom.jpg'
                        alt="person"/>
                ...
                <div>
                    <img
                        src='https://grundeinkommens-de.s3.us-west-2.amazonaws.com/daphne.jpg'
                        alt="person"/>
                ...
                <div>
                    <img
                        src='https://grundeinkommens-de.s3.us-west-2.amazonaws.com/connor.jpg'
                    alt="person"/>
